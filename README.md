...
Here is the official implementation of the model `MCGDM` in paper [Multi-Source Collaborative Gradient Discrepancy Minimization for Federated Domain Generalization](https://arxiv.org/abs/2401.10272), in AAAI 2024, [Video](https://www.youtube.com/watch?v=z9qP_ezXGRE).
