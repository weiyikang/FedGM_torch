...
Here is the official implementation of `MCGDM` method in the paper `Multi-Source Collaborative Gradient Discrepancy Minimization for Federated Domain Generalization, in AAAI 2024` [paper](https://arxiv.org/abs/2401.10272), in AAAI 2024, [Video](https://www.youtube.com/watch?v=z9qP_ezXGRE).
